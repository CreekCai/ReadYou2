...
data class Settings(
    ...
    val geminiExplanationModel: String = "gemini-3.5-flash",
    val codexExplanationModel: String = "gpt-4.1",
    val explanationPrompt: String = ExplanationPreferences.defaultPrompt,
    val explanationSearch: Boolean = false,
    val geminiTranslationModel: String = GeminiTranslationModelPreference.default,
    val geminiInsightModel: String = GeminiInsightModelPreference.default,
