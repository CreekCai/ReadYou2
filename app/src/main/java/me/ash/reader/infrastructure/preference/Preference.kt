...
fun Preferences.toSettings(): Settings {
    return Settings(
        ...
        geminiExplanationModel = this[ExplanationPreferences.geminiModel] ?: "gemini-3.5-flash",
        codexExplanationModel = this[ExplanationPreferences.openAiModel] ?: CodexModelPreference.fromPreferences(this),
        explanationPrompt = this[ExplanationPreferences.prompt] ?: ExplanationPreferences.defaultPrompt,
        explanationSearch = this[ExplanationPreferences.search] ?: false,
