...
fun Preferences.toSettings(): Settings {
    return Settings(
        ...
        ragflowBaseUrl = RagflowBaseUrlPreference.fromPreferences(this),
        ragflowApiKey = RagflowApiKeyPreference.fromPreferences(this),
        ragflowDatasetId = RagflowDatasetIdPreference.fromPreferences(this),
        ragflowChatId = RagflowChatIdPreference.fromPreferences(this),
        offlineRetentionDays = OfflineRetentionDaysPreference.fromPreferences(this),
