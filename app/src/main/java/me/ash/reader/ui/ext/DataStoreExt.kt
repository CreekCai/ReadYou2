...
sealed interface PreferencesKey {
    ...
    companion object {
        ...
        const val geminiInsightModel = "geminiInsightModel"
    ...
    companion object {
        ...
        val keys: MutableMap<String, DataStoreKey<*>> =
            mutableMapOf(
                ...
                geminiModel to
                    DataStoreKey(stringPreferencesKey(geminiModel), String::class.java),
                geminiTranslationModel to
                    DataStoreKey(stringPreferencesKey(geminiTranslationModel), String::class.java),
                geminiInsightModel to
                    DataStoreKey(stringPreferencesKey(geminiInsightModel), String::class.java),
                geminiPrompt to
                    DataStoreKey(stringPreferencesKey(geminiPrompt), String::class.java),
                geminiTranslationPrompt to
